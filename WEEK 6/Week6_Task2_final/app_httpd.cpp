...
//for task 2 MSI project
//go to line 655 & 723
extern void ServoFaceTracking(int x_angle, int myscreen);
            ...
            else
            {
                if (fb->format == PIXFORMAT_RGB565
                    ...
                    if (results.size() > 0) {
                        ...
                        //MSI project task 2
                        auto myface = results.front();
                        int face_x = (myface.box[0] + myface.box[2]) / 2;
                        ServoFaceTracking(face_x, rfb.width);
                    }
